...
entity EventMedia {
    ...
    tenantId String maxlength(255),
    title String required maxlength(255),
    description TextBlob, // Use Text for parity with SQL
...
entity DiscountCode {
    ...
    description String maxlength(255),
    discountType String maxlength(20) required, // PERCENT or FIXED
...
relationship ManyToOne {
    ...
    // User Registration Request relationships
    ...
    EventLiveUpdate{event required} to EventDetails,
                      ...
                      EventDetails{discountCodes} to DiscountCode{events}
                      }
