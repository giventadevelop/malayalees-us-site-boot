...
/**
 * Criteria class for the {@link com.nextjstemplate.domain.TicketType} entity. This class is used
 * in {@link com.nextjstemplate.web.rest.TicketTypeResource} to receive all the possible filtering options from
...
public class TicketTypeCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, description, price, code, availableQuantity, isActive, createdAt, updatedAt, eventId, distinct);
    }
