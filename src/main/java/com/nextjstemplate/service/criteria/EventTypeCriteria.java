...
/**
 * Criteria class for the {@link com.nextjstemplate.domain.EventType} entity. This class is used
 * in {@link com.nextjstemplate.web.rest.EventTypeResource} to receive all the possible filtering options from
...
public class EventTypeCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, description, createdAt, updatedAt, distinct);
    }
