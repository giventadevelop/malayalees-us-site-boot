...
/**
 * REST controller for managing {@link com.nextjstemplate.domain.EventTicketTransaction}.
 */
@RestController
...
public class EventTicketTransactionResource {
    ...
    /**
     * {@code POST  /event-ticket-transactions} : Create a new eventTicketTransaction.
     *
     * @param eventTicketTransactionDTO the eventTicketTransactionDTO to create.
     * @return the {@link ResponseEntity} with status {@code 201 (Created)} and with body the new eventTicketTransactionDTO, or with status {@code 400 (Bad Request)} if the eventTicketTransaction has already an ID.
    ...
    /**
     * {@code PUT  /event-ticket-transactions/:id} : Updates an existing eventTicketTransaction.
     *
     * @param id the id of the eventTicketTransactionDTO to save.
     * @param eventTicketTransactionDTO the eventTicketTransactionDTO to update.
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the updated eventTicketTransactionDTO,
     * or with status {@code 400 (Bad Request)} if the eventTicketTransactionDTO is not valid,
     * or with status {@code 500 (Internal Server Error)} if the eventTicketTransactionDTO couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PutMapping("/{id}")
    ...
    /**
     * {@code PATCH  /event-ticket-transactions/:id} : Partial updates given fields of an existing eventTicketTransaction, field will ignore if it is null
     *
     * @param id the id of the eventTicketTransactionDTO to save.
     * @param eventTicketTransactionDTO the eventTicketTransactionDTO to update.
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the updated eventTicketTransactionDTO,
     * or with status {@code 400 (Bad Request)} if the eventTicketTransactionDTO is not valid,
     * or with status {@code 404 (Not Found)} if the eventTicketTransactionDTO is not found,
     * or with status {@code 500 (Internal Server Error)} if the eventTicketTransactionDTO couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    ...
    /**
     * {@code GET  /event-ticket-transactions} : get all the eventTicketTransactions.
     *
     * @param pageable the pagination information.
     * @param criteria the criteria which the requested entities should match.
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and the list of eventTicketTransactions in body.
     */
    @GetMapping("")
    ...
    /**
     * {@code GET  /event-ticket-transactions/count} : count all the eventTicketTransactions.
     *
     * @param criteria the criteria which the requested entities should match.
    ...
    /**
     * {@code GET  /event-ticket-transactions/:id} : get the "id" eventTicketTransaction.
     *
     * @param id the id of the eventTicketTransactionDTO to retrieve.
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the eventTicketTransactionDTO, or with status {@code 404 (Not Found)}.
     */
    @GetMapping("/{id}")
    ...
    /**
     * {@code DELETE  /event-ticket-transactions/:id} : delete the "id" eventTicketTransaction.
     *
