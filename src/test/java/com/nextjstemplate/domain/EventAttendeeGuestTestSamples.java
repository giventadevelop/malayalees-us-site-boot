...
public class EventAttendeeGuestTestSamples {
    ...
    public static EventAttendeeGuest getEventAttendeeGuestSample1() {
        return new EventAttendeeGuest().id(1L).tenantId("tenantId1").guestName("guestName1").specialRequirements("specialRequirements1");
    }

    public static EventAttendeeGuest getEventAttendeeGuestSample2() {
        return new EventAttendeeGuest().id(2L).tenantId("tenantId2").guestName("guestName2").specialRequirements("specialRequirements2");
    }
