...
class EventResourceIT {
    ...
    @Test
    @Transactional
    void getAllEventsByStartTimeIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        eventRepository.saveAndFlush(event);

        // Get all the eventList where startTime is greater than or equal to DEFAULT_START_TIME
        defaultEventShouldBeFound("startTime.greaterThanOrEqual=" + DEFAULT_START_TIME);

        // Get all the eventList where startTime is greater than or equal to UPDATED_START_TIME
        defaultEventShouldNotBeFound("startTime.greaterThanOrEqual=" + UPDATED_START_TIME);
    }

    @Test
    @Transactional
    void getAllEventsByStartTimeIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        eventRepository.saveAndFlush(event);

        // Get all the eventList where startTime is less than or equal to DEFAULT_START_TIME
        defaultEventShouldBeFound("startTime.lessThanOrEqual=" + DEFAULT_START_TIME);

        // Get all the eventList where startTime is less than or equal to SMALLER_START_TIME
        defaultEventShouldNotBeFound("startTime.lessThanOrEqual=" + SMALLER_START_TIME);
    }

    @Test
    @Transactional
    void getAllEventsByStartTimeIsLessThanSomething() throws Exception {
        // Initialize the database
        eventRepository.saveAndFlush(event);

        // Get all the eventList where startTime is less than DEFAULT_START_TIME
        defaultEventShouldNotBeFound("startTime.lessThan=" + DEFAULT_START_TIME);

        // Get all the eventList where startTime is less than UPDATED_START_TIME
        defaultEventShouldBeFound("startTime.lessThan=" + UPDATED_START_TIME);
    }

    @Test
    @Transactional
    void getAllEventsByStartTimeIsGreaterThanSomething() throws Exception {
        // Initialize the database
        eventRepository.saveAndFlush(event);

        // Get all the eventList where startTime is greater than DEFAULT_START_TIME
        defaultEventShouldNotBeFound("startTime.greaterThan=" + DEFAULT_START_TIME);

        // Get all the eventList where startTime is greater than SMALLER_START_TIME
        defaultEventShouldBeFound("startTime.greaterThan=" + SMALLER_START_TIME);
    }
    ...
    @Test
    @Transactional
    void getAllEventsByEndTimeIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        eventRepository.saveAndFlush(event);

        // Get all the eventList where endTime is greater than or equal to DEFAULT_END_TIME
        defaultEventShouldBeFound("endTime.greaterThanOrEqual=" + DEFAULT_END_TIME);

        // Get all the eventList where endTime is greater than or equal to UPDATED_END_TIME
        defaultEventShouldNotBeFound("endTime.greaterThanOrEqual=" + UPDATED_END_TIME);
    }

    @Test
    @Transactional
    void getAllEventsByEndTimeIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        eventRepository.saveAndFlush(event);

        // Get all the eventList where endTime is less than or equal to DEFAULT_END_TIME
        defaultEventShouldBeFound("endTime.lessThanOrEqual=" + DEFAULT_END_TIME);

        // Get all the eventList where endTime is less than or equal to SMALLER_END_TIME
        defaultEventShouldNotBeFound("endTime.lessThanOrEqual=" + SMALLER_END_TIME);
    }

    @Test
    @Transactional
    void getAllEventsByEndTimeIsLessThanSomething() throws Exception {
        // Initialize the database
        eventRepository.saveAndFlush(event);

        // Get all the eventList where endTime is less than DEFAULT_END_TIME
        defaultEventShouldNotBeFound("endTime.lessThan=" + DEFAULT_END_TIME);

        // Get all the eventList where endTime is less than UPDATED_END_TIME
        defaultEventShouldBeFound("endTime.lessThan=" + UPDATED_END_TIME);
    }

    @Test
    @Transactional
    void getAllEventsByEndTimeIsGreaterThanSomething() throws Exception {
        // Initialize the database
        eventRepository.saveAndFlush(event);

        // Get all the eventList where endTime is greater than DEFAULT_END_TIME
        defaultEventShouldNotBeFound("endTime.greaterThan=" + DEFAULT_END_TIME);

        // Get all the eventList where endTime is greater than SMALLER_END_TIME
        defaultEventShouldBeFound("endTime.greaterThan=" + SMALLER_END_TIME);
    }
